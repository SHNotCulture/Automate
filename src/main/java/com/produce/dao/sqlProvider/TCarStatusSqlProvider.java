...
import com.produce.entity.TCarStatusCriteria.Criteria;
import com.produce.entity.TCarStatusCriteria.Criterion;
...
public class TCarStatusSqlProvider {
    ...
    public String insertSelective(TCarStatus record) {
        ...
        if (record.getInTime() != null) {
            sql.VALUES("in_time", "#{inTime,jdbcType=INTEGER}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getInTime() != null) {
            sql.SET("in_time = #{record.inTime,jdbcType=INTEGER}");
        }
    ...
    public String updateByPrimaryKeySelective(TCarStatus record) {
        ...
        if (record.getInTime() != null) {
            sql.SET("in_time = #{inTime,jdbcType=INTEGER}");
        }
