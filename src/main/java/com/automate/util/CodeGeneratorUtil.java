...
import com.produce.util.ProjectConstant;
...
public class CodeGeneratorUtil {
    // JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/carowner";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "123456";
    private static final String JDBC_DIVER_CLASS_NAME = "com.mysql.jdbc.Driver";
    // 模板位置
    private static final String TEMPLATE_FILE_PATH = "src/test/java/generator";
    ...
    // @author
    private static final String AUTHOR = "李书瀚";
    // @date
    ...
    public static void main(String[] args) {
        genCode("t_bill");
        genCode("t_car_owner");
        genCode("t_car_record");
        genCode("t_car_status");
        genCode("t_card_coupon");
        genCode("t_card_sequence");
        genCode("t_journal_event");
        genCode("t_journal_process");
        genCode("t_notice");
        genCode("t_owner_plot");
        genCode("t_park_car");
        genCode("t_pay_sequence");
    }
